...
define(function(require) {
  ...
  function _elementArray(element_json) {
    ...
    if (OpenNebulaVM.isVNCSupported(element)) {
      if(config && config.system_config && config.system_config.vnc_proxy_type){
        const type = config.system_config.vnc_proxy_type;
        switch (type) {
          case "guacamole":
            vncIcon = "<a class=\"guacamole\" href=\"#\" vm_id=\"" + element.ID + "\"><i class=\"fas fa-desktop\"/></a>";
          break;
          default:
